...
question = 'What are different types of bonds'
...
def query_handler():
    ...
    if not os.path.exists(persist_directory):
        ...
        file_content = read_chroma_db_from_drive('https://drive.google.com/drive/folders/15mAFSc1K3mo1lDO5ZAmFEURcaR_3QMvB?usp=sharing')
